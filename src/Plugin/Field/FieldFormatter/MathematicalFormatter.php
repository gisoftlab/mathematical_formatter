 ...
 * )
 */
class MathematicalFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
    ...
    /**
     * MathematicalFormatter constructor.
     * @param $plugin_id
        ...
        foreach ($items as $delta => $item) {
            $elements[$delta] = [
                ...
                '#attributes' => [
                    ...
                    'compute' => $this->parser->parse([$item->value]),
                    'formula' => $item->value,
                ],
